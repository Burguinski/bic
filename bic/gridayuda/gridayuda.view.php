<div>
    <?php 
        ...
        $filter_ambitos_html = wp_dropdown_categories( $args );
        ...
        $filter_tiposempresa_html .= "<option value=''>".__("Tipos de empresa", 'bic')."</option>";
        ...
        if(isset($_REQUEST['filter_ambito'.$formlabel])  && $_REQUEST['filter_ambito'.$formlabel] > 0) {
            $args['tax_query'][] = [
                'taxonomy' => 'sector',
                'field'    => 'term_id',
                'terms'    => $_REQUEST['filter_ambito'.$formlabel]
            ];
            $filtered = true;
        }
